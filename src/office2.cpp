...
float param[NUM_OBJECTS][6] = {
   {0.5, 0.5, 0.5, 0.5, 0.5, 0.6}, 
   {-0.5, -0.5, -0.5, 0.8, 0.5, 0.7},
   {0.5, -0.5, 0.5, 0.5, 1.2, 0.2},
   {-0.5, 0.5, -0.5, 0.5, 1.2, 0.2} };
...
void keyboard(unsigned char key, int x, int y)
{
   ...
   {
      if (key == 'x')
         param[selected][0] -= 0.05;
      else if (key == 'y')
         param[selected][1] -= 0.05;
      else if (key == 'z')
         param[selected][2] -= 0.05;
      else if (key == 'X')
         param[selected][0] += 0.05;
      else if (key == 'Y')
         param[selected][1] += 0.05;
   ...
   {
      if (key == 'x')
         param[selected][3] -= 0.05;
      else if (key == 'y')
         param[selected][4] -= 0.05;
      else if (key == 'z')
         param[selected][5] -= 0.05;
      else if (key == 'X')
         param[selected][3] += 0.05;
      else if (key == 'Y')
         param[selected][4] += 0.05;
...
void display()
{
   ...
   for (i=0; i<4; i++)
   {
      // Draw table
      if (object[i] == 't')
         table(param[i][0], param[i][1], param[i][2], 
            param[i][3], param[i][4], param[i][5], i==selected);
 
      // Draw book case
      else if (object[i] == 'b')
         book_case(param[i][0], param[i][1], param[i][2], 
            param[i][3], param[i][4], param[i][5], i==selected);
   }
   glFlush();
}
